...
class Game:
    ...
    def draw_possible_moves(self, window):
        if not self.board.check_color:
            ...
            moves = []
            for available_move in self.board.legal_moves_on_check:
    ...
    def move_on_board(self):
        ...
        if king.check_check(self.board.fields):
            ...
            self.board.set_legal_moves_on_check()
            if not self.board.legal_moves_on_check:
